...
function ffsb_slider_add_options_function() {
    ...
    <?php } ?>
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="add_text" class="" value="<?php if(isset($current_text)) echo esc_html($current_text); ?>" maxlength="30"/><?php echo esc_html('  - Max 30 characters.'); ?></td>
                </tr>
                <tr valign="top">
    ...
    ?>
                        ...
                        <?php for ($k = 1; $k <= $total_slides; $k++) { ?>
                                <option <?php if (isset($current_pos) && $current_pos == $k ) { ?> selected="selected"<?php } ?> value="<?php echo $k; ?>"><?php echo $k; ?></option>
                            <?php } ?>
                        </select>
