...
*/
function cws_fgp_shortcode_favourites( $atts ) {
...
*/
    ...
    // Get ALL photos
    $photos = $tbPhpFlickr->favorites_getList($user['id'], $jump_to = NULL, $min_fave_date = NULL, $max_fave_date = NULL, $arrArgs['extras'], $per_page = $num_image_results , $page = $cws_page );
