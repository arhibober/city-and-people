...
if ( ! class_exists( 'Awl_Flickr_Gallery' ) ) {
	...
	class Awl_Flickr_Gallery {
		...
		public function fg_gallery_menu() {
			...
			$fg_help_menu_premium  = add_submenu_page( 'edit.php?post_type=' . FG_PLUGIN_SLUG, __( 'Buy Premium Plugin', 'wp-flickr-gallery' ), __( 'Buy Premium Plugin', 'wp-flickr-gallery' ), 'administrator', 'ag-premium-page', array( $this, '_fg_premium_page' ) );
